...
public class AuthenticationController {
    ...
    public ResponseMessage<UserToken> authenticate(@RequestBody Users users) {
        Users authenticatedUser = authenticationService.login(users);
    ...
    @GetMapping("/logout")
    public ResponseMessage<String> logout(@RequestHeader (name="Authorization") String authHeader, HttpSession session) {
